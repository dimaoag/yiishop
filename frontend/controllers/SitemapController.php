...
class SitemapController extends Controller
{
    ...
    {
        return \Yii::$app->response->sendContentAsFile(\Yii::$app->cache->getOrSet($key, $callback, null, $dependency), Url::canonical(), [ //Url::canonical()  - названия файла по которому мы ввошли через UrlManager
